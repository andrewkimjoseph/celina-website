...
export const GENERATED_HOSTED_TOOL_COUNT = 50;
...
export const GENERATED_TOOLS: Omit<ToolDoc, "returns">[] = [
  ...
  },
  {
    ...
    "slug": "get-mento-swap-pairs",
    "title": "Get Mento Swap Pairs",
    "summary": "List tradable Mento FX registry-token pairs on Celo mainnet.",
    "description": "List tradable Mento FX registry-token pairs on Celo mainnet. Call this before listing Mento pairs — do not invent them.",
    "kind": "read",
    "category": "Mento FX",
    "inputs": [
      {
        ...
        "type": "string",
        "required": false,
        "description": "Optional registry token. When set, only pairs involving this token are returned."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "slug": "get-uniswap-swap-pairs",
    "title": "Get Uniswap Swap Pairs",
    "summary": "List Uniswap v4 registry-token pairs on Celo mainnet (direct pools and 2-hop routes).",
    "description": "List Uniswap v4 registry-token pairs on Celo mainnet (direct pools and 2-hop routes). Call this before listing Uniswap pairs — do not invent them.",
    "kind": "read",
    "category": "Uniswap",
    "inputs": [
      {
