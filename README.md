...
- Hosted endpoint: `https://mcp.usecelina.xyz/api/mcp` — **30 tools** (reads + quotes; no `estimate_*` or server-key writes). Public read-only — no API key; see [celina-mcp-host SECURITY.md](../celina-mcp-host/SECURITY.md).
